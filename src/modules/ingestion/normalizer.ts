...
- parenting: 아이가 **직접** 쓰는 제품·서비스 (이유식·기저귀·완구·교구·아동복·아기 로션·키즈모델)
- living: 살림 + 어른·가족이 쓰는 제품 전부 (가전·가구·식기·청소·침구·성인 화장품·성인 의류·건강식품·기프티콘)
※ 예외: 산모·예비맘 용품(산모 영양제·산모차·수유브라·튼살크림·젠더리빌·임신선물박스)은 parenting + ["pregnancy"]
※ 애매하면 living (어른 제품이 육아 탭에 섞이는 것을 막는 게 우선)
※ living 이면 stage_categories 는 반드시 ["all_ages"] 단독 (다른 시기와 섞지 않음)
...
- 단순 정보 글
- 경품이 소액 기프티콘·적립금뿐인 이벤트 (2026-09-15 정책: 커피·적립금·편의점/올리브영 소액 상품권·베이커리류 제외. 백화점 상품권·네이버페이·치킨·실물 제품이 있으면 true)
- 현장 방문형 이벤트 (2026-09-22 정책: 팝업스토어·박람회(베페 등)·매장/행사장 방문이 참여나 경품 수령 조건이면 false. 온라인 응모로 끝나고 경품이 택배·모바일로 오면 true. 온라인 응모+오프라인 혜택(초대권·클래스)은 true 로 두되 confidence 0.5)
