...
- 2026-09-15 **경품이 커피 기프티콘·적립금뿐인 이벤트 제외** (와이프 요청): RULES.md skip #11 · REVIEW-RULES 치명 결격 #6 · vision-extractor/normalizer. 실물 제품이 주된 경품이면 유지, 치킨·상품권·네이버페이 같은 애매한 금액권은 skip 대신 warn(사람 판단). 기존 발행분은 워크플로우 스윕으로 정리(워크로그 §7)
